...
if __name__ == "__main__":
    # SMIC 数据集（已裁剪，仅计算光流）
    smic_input_folder = '/kaggle/working/SMIC_onset_apex_offset_retinaface'
    smic_output_folder = "/kaggle/working/SMIC_optflow_retinaface"
    main(smic_input_folder, smic_output_folder)
    zipPath = '/kaggle/working/SMIC_optflow_retinaface.zip'
    zip_frames(smic_output_folder, zipPath)
    print_directory_structure(smic_output_folder, directory_name='SMIC_optflow_retinaface')
